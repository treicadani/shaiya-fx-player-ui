...
Cloud.setup({
  ...
  methods: {
    ...
    "logout":{
      "verb":"GET","url":"/api/v1/account/logout",
      "args":[]
    },
    "updatePassword":{
    ...
    "login":{
      "verb":"PUT",
      "url":"/api/v1/start/login",
      "args":["emailAddress","password","rememberMe"]
    },"signup":{
      "verb":"POST",
      "url":"/api/v1/start/signup",
      "args":["emailAddress","password","fullName"]
    },
    "sendPasswordRecoveryEmail":{
      "verb":"POST",
      "url":"/api/v1/start/send-password-recovery-email",
      "args":["emailAddress"]
    },
    "updatePasswordAndLogin":{
      "verb":"POST",
      "url":"/api/v1/start/update-password-and-login",
      "args":["password","token"]
    },
